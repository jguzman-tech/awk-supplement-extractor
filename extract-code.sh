...
# Extract files from awkcode.txt (provided here:
# https://www.cs.princeton.edu/~bwk/btl.mirror/awkcode.txt), which is a
# supplementary material provided by one of the authors of "The Awk Programming
# Language". This script is helpful because it gives you a TUI menu for
# selecting an example among the 236 examples provided in that one awkcode.txt
# resource.
